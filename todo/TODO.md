...
- [ ] Run one documented openpi LIBERO fine-tuning example end-to-end and capture reproducible commands/artifacts ([plan](todo/20260219-openpi-libero-finetune-example.md))
  - [ ] Run norm-stats computation for a chosen LIBERO training config.
  - [ ] Launch a bounded fine-tuning run and verify checkpoints/logging output.
  - [ ] Document exact command line, config, and artifact paths in `tasks/`.
